...
export default function Navbar() {
    ...
    return (
        <>
            ...
            <div className={isMobileMenuOpen ? " ease-in duration-500 text-white h-screen z-10   w-screen  bg-gray-800 fixed top-0 left-0  " : "  ease-in duration-500 h-screen  z-10  align-middle  bg-gray-600 text-white fixed top-0 left-[-100%]"}>
